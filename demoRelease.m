...
addpath D:\standardmodelmatlabrelease\osu-svm %put your own path to osusvm here
...
if ~READPATCHESFROMFILE
  ...
  cPatches = extractRandC1Patches(cI{1}, numPatchSizes, numPatchesPerSize, patchSizes); %fix: extracting from positive only 
